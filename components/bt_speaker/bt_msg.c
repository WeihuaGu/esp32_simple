#include "bt_msg.h"
static const char * BT_APP_CORE_TAG = "bt msg";
...
static void bt_app_msg_task(void *arg)
{
    bt_app_msg_t msg;
...
void bt_msg_task_start_up(void)
{
    ...
    xTaskCreate(bt_app_msg_task, "Bt Msg Task", configMINIMAL_STACK_SIZE*2, NULL, 1, &s_bt_app_task_handle);
}
